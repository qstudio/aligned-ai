...
import { Dices, Coins, Calculator, MessageCircleQuestion, ListChecks } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white to-decision-light">
        ...
        <div className="space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground">
              Let us help you make those small decisions
            </p>
          </div>
      ...
      <footer className="py-6 text-center text-sm text-muted-foreground">
        <p>© {new Date().getFullYear()} Decision Helper - Making small choices easier</p>
      </footer>
    </div>
  );
};
